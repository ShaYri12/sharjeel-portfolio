...
const Home = () => {
  return (
    <motion.div
      ...
      className="min-h-[80vh] flex flex-col justify-center xl:justify-between py-12 xl:py-6"
    >
          ...
          <div className="flex flex-col gap-4 w-auto max-w-[380px] text-center xl:text-left">
            ...
            >
              <h1 className="h1">
                Hey there!
                <br />
                I'm <span className="text-accent">Sharjeel.</span>
              </h1>
            </motion.div>
            {/* bio */}
            <motion.div
            ...
            <div className="flex flex-col xl:flex-row items-center justify-center xl:items-center xl:justify-start gap-6 pt-2">
              <motion.a
                ...
                whileInView={"show"}
                viewport={{ once: false, amount: 0.2 }}
                href="/assets/Sharjeel-CV.pdf"
                download
                aria-label="Download Sharjeel's CV"
              >
                <Button
                  variant="outline"
                  size="md"
