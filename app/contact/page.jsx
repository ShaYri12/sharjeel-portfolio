...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+92) 308 2741094",
    action: () => (window.location.href = "tel:+923082741094"),
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "sharjeelb60@gmail.com",
    action: () => (window.location.href = "mailto:sharjeelb60@gmail.com"),
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Location",
    description: "Lyari, Karachi, Pakistan",
    action: () =>
      window.open("https://www.google.com/maps?q=Lyari+Karachi", "_blank"),
  },
];
